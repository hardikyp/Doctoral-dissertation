...
% Department
\department{Civil and Environmental Engineering and Scientific Computing}
...
% Author ORCID iD
\orcid{0009\textendash{}0006\textendash{}9191\textendash{}3738}

% Frontispiece
% \frontispiece{\includegraphics[width=\textwidth]{00-front-material/frontispiece.png}}

% Dedication
\dedication{\input{00-front-material/dedication}}

% Acknowledgments
\acknowledgments{\input{00-front-material/acknowledgments}}
...
% \acronyms{
%     \acro{3NTS}{Three-node Torsional Spring}
% }
...
% Some abstract text
\abstract{
\input{00-front-material/abstract}
}
...
\doublespacing{}
\input{02-chapters/01-chapter.tex}
\input{02-chapters/02-chapter.tex}
\input{02-chapters/03-chapter.tex}
\input{02-chapters/04-chapter.tex}
\input{02-chapters/05-chapter.tex}
\input{02-chapters/06-chapter.tex}

% Appendices
\appendix{
\input{03-appendices/01-appendix.tex}
\input{03-appendices/02-appendix.tex}
\input{03-appendices/03-appendix.tex}
}
