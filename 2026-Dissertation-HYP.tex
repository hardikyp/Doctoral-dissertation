...
% Title of the thesis
\title{Static Structural Topologies into Functional Reconfigurable Systems}
...
\input{02-chapters/example_chapter_01}
\input{02-chapters/example_chapter_99}

% Appendices
\appendix
\input{{03-appendices/01-appendix}}
